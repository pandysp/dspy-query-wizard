...
# 1. Rename ALL existing methods to avoid conflicts/overrides
# This handles both original methods and any previous patch attempts
...
content = re.sub(r"def\s+filter_pids\s*\(", "def _ignore_filter_pids(", content)
content = re.sub(r"def\s+decompress_residuals\s*\(", "def _ignore_decompress_residuals(", content)
...
# 3. Insert methods at the top of the class
