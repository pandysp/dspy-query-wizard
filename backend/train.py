...
def train(sample_size: int = 20) -> None:
    ...
    if not os.path.exists(data_path):
        logger.error(f"Training data not found at {data_path}. Run data_preprocess.py first.")
        return
    ...
    # 5. Save
    output_path = os.path.join(os.path.dirname(__file__), "data", "compiled_machine_rag.json")
